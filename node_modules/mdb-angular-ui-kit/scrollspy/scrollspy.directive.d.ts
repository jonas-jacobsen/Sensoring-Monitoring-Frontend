...
export declare class MdbScrollspyDirective implements OnInit, AfterContentInit, OnDestroy {
    ...
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<MdbScrollspyDirective, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<MdbScrollspyDirective, "[mdbScrollspy]", never, { "id": "mdbScrollspy"; }, { "activeLinkChange": "activeLinkChange"; }, ["links"], ["*"]>;
}

//# sourceMappingURL=scrollspy.directive.d.ts.map